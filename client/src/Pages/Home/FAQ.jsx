...
const questions = [
  {
    title: "What is E-Medicine?",
    content:
      "E-Medicine is an intensive summer program designed to provide students with an immersive learning experience in various subjects. It offers a unique combination of academic courses, hands-on workshops, and recreational activities to enhance knowledge, skills, and personal development.",
  },
  {
    title: "Who can participate in E-Medicine?",
    content:
      "E-Medicine is open to students of all ages and educational backgrounds. Whether you're in elementary, middle, or high school, or even a college student seeking additional enrichment, E-Medicine welcomes participants from diverse backgrounds and interests.",
  },
  {
    title: "What courses and activities are offered at E-Medicine?",
    content:
      "E-Medicine offers a wide range of courses and activities to cater to different interests. Some examples include coding and programming, robotics, creative writing, entrepreneurship, art and design, sports and outdoor adventures, and team-building exercises. Please check our program schedule for a complete list of available courses.",
  },
  {
    title: "How long is E-Medicine, and where is it located?",
    content:
      "E-Medicine typically runs for four weeks during the summer vacation. The exact dates may vary each year, so it's important to check our website for the latest information. As for the location, our camp is situated in a picturesque setting, combining natural surroundings with modern facilities. Please refer to our website for the specific location details.",
  },
  {
    title: "How can I register for E-Medicine, and what is the cost?",
    content:
      "To register for E-Medicine, you can visit our website and navigate to the registration page. There, you will find instructions on how to complete the registration process. As for the cost, fees may vary depending on the duration of the program and the chosen courses. Please refer to the registration page or contact our team for detailed information regarding fees and payment options.",
  },
  {
    title: "What is the daily schedule like at E-Medicine?",
    content:
      "The daily schedule at E-Medicine is carefully structured to provide a balanced mix of academic learning, hands-on activities, and recreational time. Each day typically starts with morning classes or workshops, followed by lunch and afternoon sessions. Afternoons are often dedicated to engaging in sports, outdoor adventures, or group activities. Evenings may include special events, guest speakers, or social activities to foster connections among participants. Rest assured, we prioritize both learning and fun throughout the day.",
  },
];
